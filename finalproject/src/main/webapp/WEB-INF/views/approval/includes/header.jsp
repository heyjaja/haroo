          ...
          <svg xmlns="http://www.w3.org/2000/svg" width="30" height="30" fill="currentColor" class="bi bi-cloud-fill" viewBox="0 0 16 16">
            ...
            <ul class="nav col-12 col-lg-auto me-lg-auto mb-2 justify-content-center mb-md-0">
                <li class="nav-item dropdown">
                  <a class="nav-link px-2 text-secondary dropdown-toggle" href="#" id="dropdown01" data-bs-toggle="dropdown" aria-expanded="false">
                    haroo</a>
                  <ul class="dropdown-menu" aria-labelledby="dropdown01">
                    <li><a class="dropdown-item" href="#">인사정보</a></li>
                    <li><a class="dropdown-item" href="/attandance/status">근태관리</a></li> 
            ...
            <div class="text-end">
              <ul class="nav col-12 col-lg-auto me-lg-auto mb-2 justify-content-center mb-md-0">
                ...
                <li class="nav-item">
                  <a class="nav-link link-secondary" href="/mypage"><svg xmlns="http://www.w3.org/2000/svg" width="25" height="25" fill="currentColor" class="bi bi-person" viewBox="0 0 16 16">
...
<nav>
    <ul class="nav justify-content-center alert-info" style="padding-top: 15px;">
        <li class="nav-item"><a class="nav-link link-dark text-center" href="/department/departmentAction.do">
        ...
        <li class="nav-item"><a class="nav-link link-dark text-center" href="/board/listAction.do">
        ...
        <li class="nav-item"><a class="nav-link link-dark text-center" href="/approval">
          ...
          <p>전자결재</p></a></li>
        <li class="nav-item"><a class="nav-link link-dark text-center" href="/chat/chatFormAction.do">
  ...
  <div class="p-3 bg-white" style="width: 280px;">
    <a href="/approval" class="d-flex align-items-center pb-3 mb-3 link-dark text-decoration-none border-bottom">
      ...
      <li class="mb-1">
        ...
        <div class="collapse" id="form-collapse" style="">
          <ul class="btn-toggle-nav list-unstyled fw-normal pb-1 small">
            <li><a href="/approval/report/1" class="ap-link link-dark rounded">기안서</a></li>
            <li><a href="/approval/report/2" class="ap-link link-dark rounded">품의서</a></li>
            <li><a href="/approval/report/3" class="ap-link link-dark rounded">휴가신청서</a></li>
