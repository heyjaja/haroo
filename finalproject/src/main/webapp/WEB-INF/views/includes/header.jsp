            ...
            <ul class="nav col-12 col-lg-auto me-lg-auto mb-2 justify-content-center mb-md-0">
                <li class="nav-item dropdown">
                  ...
                  <ul class="dropdown-menu" aria-labelledby="dropdown01">
                    <li><a class="dropdown-item" href="hrm.html">인사정보</a></li>
                    <li><a class="dropdown-item" href="/haroo/attendance/status">근태관리</a></li> 
                    <li><a class="dropdown-item" href="/haroo/task">캘린더</a></li>
                    <li><a class="dropdown-item" href="/haroo/board/listAction.do">게시판</a></li>
                    <li><a class="dropdown-item" href="#">설문조사</a></li>
                    <li><a class="dropdown-item" href="/haroo/ap/main">전자결재</a></li>
                    <li><a class="dropdown-item" href="/haroo/chat/chatFormAction.do">채팅</a></li>
                  </ul>
                </li>
            </ul>
				<div class="text-end">
					<ul
						...
						<li class="nav-item"><a class="nav-link link-secondary">${employeeVO.em_name}님
								환영합니다 :)</a></li>
                  ...
                  <path
						...
						<li class="nav-item"><a class="nav-link link-secondary"
							href="/haroo/mypage"><svg xmlns="http://www.w3.org/2000/svg"
									width="25" height="25" fill="currentColor" class="bi bi-person"
									viewBox="0 0 16 16">
                  <path
	...
	<nav>
		<ul class="nav justify-content-center alert-info"
			...
			<li class="nav-item"><a class="nav-link link-dark text-center"
				href="#"> <svg xmlns="http://www.w3.org/2000/svg" width="40"
						height="40" fill="currentColor" class="bi bi-emoji-smile"
						viewBox="0 0 16 16">
            <path
			...
			<li class="nav-item"><a class="nav-link link-dark text-center"
				href="#"> <svg xmlns="http://www.w3.org/2000/svg" width="40"
						height="40" fill="currentColor" class="bi bi-briefcase"
						viewBox="0 0 16 16">
            <path
